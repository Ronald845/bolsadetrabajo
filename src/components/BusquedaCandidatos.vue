...
export default {
    ...
    return {
      ...
      filtrosPrincipales: [
        { 
          ...
          icon: 'fas fa-search', 
          placeholder: 'Nombre, habilidades, puesto...', 
          'help-text': 'Busca por nombre, habilidades o experiencia' 
        },
        { 
          key: 'puestoBuscado', 
          type: 'text', 
          ...
          placeholder: 'Desarrollador, Contador...', 
          'help-text': 'Filtrar por el puesto deseado del candidato' 
        },
        { 
          key: 'ubicacion', 
          type: 'select', 
          ...
          options: [], 
          'help-text': 'Departamento donde reside el candidato' 
        }
      ],
  ...
  computed: {
      ...
      return [
        {
          ...
          filtros: [
            { 
              key: 'nivelFormacion', 
              type: 'select', 
              label: 'Nivel Mínimo de Formación', 
              icon: 'fas fa-diploma', 
              options: this.nivelesFormacionOptions 
            },
            { 
              key: 'institucion', 
              type: 'text', 
              label: 'Institución Específica', 
        ...
        },
        {
          ...
          filtros: [
            ...
            { 
              ...
              placeholder: 'Nombre de empresa anterior...' 
            }
          ]
        },
        {
          ...
          filtros: [
            { 
              ...
              icon: 'fas fa-code', 
              placeholder: 'JavaScript, Python, Gestión de proyectos...', 
              rows: 3, 
              'help-text': 'Separa las habilidades con comas' 
            },
            { 
              key: 'nivelHabilidad', 
              type: 'select', 
              label: 'Nivel Mínimo de Habilidad', 
              icon: 'fas fa-star', 
              options: this.nivelesHabilidadOptions 
            }
          ]
        },
        {
          ...
          filtros: [
            ...
            { 
              ...
              options: this.nivelesIdiomaOptions, 
              colClass: 'col-6' 
            },
            { 
              key: 'certificaciones', 
              ...
              placeholder: 'PMP, AWS, Scrum Master...' 
            }
          ]
        }
      ]
    ...
    accionesCandidato() {
      return [
        ...
        { 
          key: 'favorito', 
          getLabel: (c) => c.esFavorito ? 'Quitar de Favoritos' : 'Agregar a Favoritos', 
          icon: 'fas fa-heart', 
          metodo: this.marcarFavorito 
        }
      ]
    },
    ...
    nivelesFormacionOptions() {
      return [
        ...
        ...['Primaria', 'Secundaria', 'Técnico', 'Tecnólogo', 'Universitario', 'Postgrado', 'Maestría', 'Doctorado']
          .map(nivel => ({ 
            value: nivel, 
            label: nivel === 'Primaria' ? 'Educación Primaria' : 
                   nivel === 'Secundaria' ? 'Educación Secundaria' : 
                   nivel === 'Técnico' ? 'Técnico Superior' : nivel 
          }))
      ]
    },
    ...
    nivelesHabilidadOptions() {
      return [
        { value: '', label: 'Cualquier nivel' }, 
        ...['Básico', 'Intermedio', 'Avanzado', 'Experto'].map(n => ({ value: n, label: n }))
      ]
    },
    ...
    idiomasOptions() {
      return [
        ...
        ...['Inglés', 'Francés', 'Portugués', 'Italiano', 'Alemán', 'Chino Mandarín'].map(i => ({ value: i, label: i }))
      ]
    },
  ...
  methods: {
    ...
    // ✅ MÉTODO CORREGIDO - Ahora es un method, no computed
    ...
    ordenarResultados() {
      const criterios = {
        ...
        formacion: (a, b) => {
          const niveles = { 
            'Doctorado': 8, 'Maestría': 7, 'Postgrado': 6, 'Universitario': 5, 
            'Tecnólogo': 4, 'Técnico': 3, 'Secundaria': 2, 'Primaria': 1 
          }
    ...
    cambiarPagina(pagina) {
      if (pagina >= 1 && pagina <= this.totalPaginas) {
        ...
        document.querySelector('.busqueda-candidatos')?.scrollIntoView({ 
          behavior: 'smooth', 
          block: 'start' 
        })
      }
...
.candidato-card.border-success { 
  border-left-color: #10b981; 
}

.candidato-card.border-warning { 
  border-left-color: #f59e0b; 
}

.candidato-card.border-info { 
...
.compatibilidad-score .progress { 
  border-radius: 10px; 
  background-color: #e5e7eb; 
}

.compatibilidad-score .progress-bar { 
  border-radius: 10px; 
